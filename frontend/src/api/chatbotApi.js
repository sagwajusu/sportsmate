...
export const chatbotApi = {
  ...
  messages: (sessionId, params = {}) => apiClient.get(`/chatbot/sessions/${sessionId}/messages`, { params }).then((res) => res.data),
  sendMessage: (sessionId, payload) => apiClient.post(`/chatbot/sessions/${sessionId}/message`, payload).then((res) => res.data),
  memory: () => apiClient.get("/chatbot/memory").then((res) => res.data),
  updateSession: (sessionId, payload) => apiClient.put(`/chatbot/sessions/${sessionId}`, payload).then((res) => res.data),
